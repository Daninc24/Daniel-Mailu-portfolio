...
const NavbarMain = () => {
  ...
  return (
    <nav className='max-w-[1300px] mx-auto p-4 w-full fixed left-[50%] -translate-x-[50%] z-20 flex gap-4 mt-2 sm:flex'>
        ...
        <button className='text-2xl p-4 border border-orange rounded-full text-white' onClick={toggleMenu}> 
          <GiHamburgerMenu/>
        </button>
        </div>
    </nav>
